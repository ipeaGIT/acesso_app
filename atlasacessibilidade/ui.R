        ...
        , navbarPage("", id = "tabs",
                     # tabsetPanel(id = "tabs",
                                 ...
                                 tabPanel(id = "tab_graphs", title = uiOutput('title_graph'),
                                          absolutePanel(id = "controls_graphs", class = "panel panel-default", fixed = TRUE, draggable = FALSE,
                                                        top = 80, right = 20, width = 420, height = 615,
                                                        uiOutput('graphs')
                                          ),
                                          # panel to but download button
                                          absolutePanel(id = "download_panel", class = "panel panel-default", fixed = TRUE, draggable = FALSE,
                                          ...
                                          absolutePanel(id = "controls_graphs1", class = "panel panel-default", fixed = TRUE, draggable = FALSE,
